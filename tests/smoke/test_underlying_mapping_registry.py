"""Focused tests for explicit underlying configuration mappings."""

from __future__ import annotations

import pytest

from icapa.helpers import (
...
def _profile(label: str) -> UnderlyingProfile:
...
def test_exact_mapping_wins_before_longest_prefix():
    registry = UnderlyingMappingRegistry()
...
def test_registry_has_no_default_and_replacement_is_explicit():
    ...
    with pytest.raises(UnderlyingMappingNotConfiguredError):
