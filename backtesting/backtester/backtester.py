"""In-memory runner with optional named-workspace review caching."""
...
class BacktestResult:
    """Collected review weights, contexts, and optional cache metadata."""
...
class Backtester:
    ...
    side-effect-free behaviour. A named workspace adds deterministic review
    ...
    _workspace_store: WorkspaceStore | None = field(
        init=False,
        default=None,
        repr=False,
    )
    ...
    def __post_init__(self) -> None:
        ...
        if self.workspace_name is not None:
            ...
            raise ValueError("READ_ONLY cache policy requires workspace_name")
