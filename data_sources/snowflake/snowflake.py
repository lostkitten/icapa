...
from icapa.data_sources.sql_server import QueryExecutor
...
class SnowflakePlaceholder:
    ...
    def configure(self, executor: QueryExecutor, **metadata: Any):
    ...
    def query(self, sql: str, parameters=None):
        if self.executor is None:
            raise DataSourceNotConfiguredError(
                "Snowflake is an optional placeholder and has no configured connection or default dataset"
            )
